...
class LoginEntity {
    ...
    process(data) {
        ...
        this.user = {
            ...
            role: 'user',
            permissions: ['create_request', 'view_request', 'update_request', 'delete_request']
        };

        this.session = sessionResult.data;

        console.log("Person in Need authenticated successfully");
        return {
            success: true,
            message: "Person in Need authenticated",
            data: {
                userId: this.user.id,
