...
class LogoutEntity {
    ...
    validate(data) {
        ...
        if (data.userType && data.userType !== 'platformmanager') {
            return { isValid: false, error: "Invalid user type for platform manager logout" };
        }
    ...
    process(data) {
        ...
        // Create audit log
        db.insert('auditLogs', {
            action: 'PLATFORM_MANAGER_LOGOUT',
            entityType: 'session',
        ...
        console.log("Platform Manager logout processed successfully");
        return {
            success: true,
            message: "Platform Manager logout processed",
