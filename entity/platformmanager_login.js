...
class LoginEntity {
    ...
    process(data) {
        ...
        this.user = {
            ...
            role: 'administrator',
            permissions: ['manage_categories', 'view_reports', 'generate_reports', 'system_config']
        };
        ...
        console.log("Platform Manager authenticated successfully");
        return {
            success: true,
