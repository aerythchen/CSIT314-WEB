...
// CSR Representative routes removed - all functionality now handled via AJAX on dashboard
...
async function updateRequestStatusSchema() {
    try {
        ...
        // Note: Schema constraint is now updated in schema.sql
        // We just need to update existing data to match the new constraint
        ...
        console.log('✅ Request status data updated successfully!');
